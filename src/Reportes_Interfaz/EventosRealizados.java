...
public class EventosRealizados extends javax.swing.JFrame {
    ...
    public EventosRealizados(UsuariosInfo usuarioLogueado) {
        this.usuarioLogueado = usuarioLogueado;
        
        initComponents();
        
        EventosArea.setText(Main_JavaTicket.contadoresReportes.buscarEventosRealizados());
        DeportivoLabel.setText(String.valueOf(Main_JavaTicket.contadoresReportes.contadorDeportivoRealizado()));
        MusicalLabel.setText(String.valueOf(Main_JavaTicket.contadoresReportes.contadorMusicalRealizado()));
        ReligiosoLabel.setText(String.valueOf(Main_JavaTicket.contadoresReportes.contadorReligiosoRealizado()));
        MontoGeneradoLabel.setText("Lps. " + String.valueOf(Main_JavaTicket.contadoresReportes.montoGeneradoRealizado()));
    }
    ...
    private void BotonGraficoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotonGraficoMouseClicked
        Main_JavaTicket.gestionarGraficos.setEventosRealizados(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EventosRealizados(null).setVisible(true);
            }
        });
    }
